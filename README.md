...
- Run `docker volume create describly_postgres_data` to create a docker volue in you machine. Required to persist the postgres data.
...
- Database Access [http://localhost:5000](http://localhost:5000) - use the above detail to login.
